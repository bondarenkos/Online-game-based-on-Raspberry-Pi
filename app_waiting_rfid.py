...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        customtkinter.CTkLabel(self,
                                ...
                                text = "Waiting for your card...").grid(row = 0, column = 0, pady = (100, 0))
        ...
        if self.uid == -1:
            ...
            print("User in DB") if self.checkUserExists(str(self.uid)) else self.showRegistartionWindow() 
    ...
    def showRegistartionWindow(self):
        ...
        dialog = customtkinter.CTkInputDialog(text=dialog_text, 
                                              title="Registration",
